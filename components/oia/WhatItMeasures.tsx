  ...
  return (
    <section id="what-it-measures" className="bg-white section">
      <div className="container">
        <ScrollReveal className="flex flex-col items-center text-center mb-10 sm:mb-12">
        ...
        <ScrollReveal delay={150} animation="fade-in-scale">
          <div className="max-w-3xl mx-auto bg-gray-900 rounded-2xl p-6 sm:p-8 md:p-10">
              ...
              {MEASURES.map((item, i) => (
                <div key={item.title}>
                  <div className="flex items-start gap-3 py-3 sm:py-4">
                    ...
                    <div>
                      <span className="text-white font-semibold text-sm sm:text-base">{item.title}</span>
                      <span className="text-white/50 text-sm sm:text-base"> — {item.description}</span>
                    </div>
                  </div>
                  {i < MEASURES.length - 1 && (

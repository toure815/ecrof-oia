  ...
  return (
    <section id="testimonials" className="bg-white section">
      <div className="container">
            ...
            <ScrollReveal key={story.name} delay={i * 150} animation="fade-in-scale">
              <div className="bg-gray-900 rounded-2xl overflow-hidden border border-white/5">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="bg-gray-800 flex items-center justify-center min-h-[180px] sm:min-h-[250px]">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gray-700 flex items-center justify-center">
                      <span className="text-white/30 text-2xl sm:text-3xl font-bold">{story.name[0]}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Pull quote */}
        <ScrollReveal delay={400} className="max-w-3xl mx-auto mt-10 sm:mt-12 text-center">
          <blockquote className="text-lg sm:text-xl md:text-2xl font-extrabold text-gray-900 leading-snug italic">

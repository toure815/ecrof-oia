    ...
    <section className="bg-white section">
      <div className="container">
        <ScrollReveal className="flex flex-col items-center text-center mb-14">
          ...
          <p className="text-gray-700 text-base max-w-2xl mt-4 leading-relaxed">
            Growth rarely breaks because of effort. It breaks when decisions, systems and workflows stop reinforcing each other.
          </p>
          <p className="text-gray-500 text-sm max-w-2xl mt-3 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={100} animation="fade-in-scale">
            <div className="bg-gray-900 rounded-2xl p-8 h-full border border-white/5">
